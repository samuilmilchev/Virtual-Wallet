...
{
	public class WalletExample : IWallet
	{
		// Properties
		...
		// Constructor
		public WalletExample(string walletId, string ownerId, string ownerName, Dictionary<string, decimal> initialBalances, string currentCurrency)
		{
