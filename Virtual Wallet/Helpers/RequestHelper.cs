...
namespace Virtual_Wallet.Helpers
{
    public class RequestHelper
    {
        ...
        public static string Status(string apiKey = "fca_live_FnDPZgLdeSRfq0vdWySRx83mkxo0ZW3y9g70y0aZ")
        {
            string url;
        ...
        public static string Currencies(string apiKey, Currency currencies)
        {
            string url;
        ...
        public static string Latest(string apiKey, Currency baseCurrency, Currency currencies)
        {
            string url;
        ...
        public static string Historical(string apiKey, string date, Currency baseCurrency, Currency currencies)
        {
            string url;
